...
const ManageMovies = () => {
    ...
    const addBySearch = async (e) => {
        ...
        const data = await axios.get(`${LOCAL_SERVER}/movie/search`,
            {
                params: {
    ...
    return (
        <div className="manage-movies">
            ...
            {showModal && (
                <div className="modal">
                    <span className="absolute top-[26.4%] right-[36.4%]"
            ...
            {showAddBySearch && (
                <div className="modal">
                    <span className="absolute top-[26.4%] right-[36.4%]"
                        onClick={() => setShowAddBySearch(false)}>X</span>
                    <form className="modal-content" onSubmit={handleSubmit}>
