...
const Dashboard = () => {
  ...
  const menuItems = [
    ...
    { id: "my-videos", label: "My Videos", icon: <Video size={20} /> },
  ];
    ...
    <div className="flex h-screen mt-21">
            ...
            <nav className="flex-1">
              {menuItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-1 md:px-4 md:py-3 text-left transition rounded-lg m-1 ${
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <motion.div
          ...
          className="md:bg-white bg-transparent md:p-6 rounded-2xl shadow-md"
        >
          ...
          {activeSection === "my-videos" && (
            <div>
              ...
              <p className="text-gray-600">
                All your uploaded, liked, and saved videos will appear here.
              </p>
            </div>
          )}
        </motion.div>
